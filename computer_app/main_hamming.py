...
class CameraWithImagesApp(App):
    ...
    def receive_message(self, frame):
        ...
        # === RED MASK ===
        lower_red = np.array([160, 90, 150], np.uint8)
        ...
        print(self.bool_bitstream_cleared)
        ...
        if self.bool_message_received:
            ...
            decoded_msg = hamming_codec.decode(int(self.received_message, 2), 12, hamming_codec.ParityLocation.LSB, n_parity_bits=4)
